...
public class AvatarDao {
    public static final String CREATE_QUERY = "CREATE TABLE avatars(id INTEGER PRIMARY KEY AUTOINCREMENT, head_shot VARCHAR(20) NOT NULL UNIQUE, head_src VARCHAR(20) NOT NULL UNIQUE, torso_src VARCHAR(20) NOT NULL UNIQUE, left_arm_src VARCHAR(20) NOT NULL UNIQUE, right_arm_src VARCHAR(20) NOT NULL UNIQUE, left_leg_src VARCHAR(20) NOT NULL UNIQUE, right_leg_src VARCHAR(20) NOT NULL UNIQUE, eyesId INTEGER NOT NULL DEFAULT 9, mouthId INTEGER NOT NULL, eyebrowsId INTEGER NOT NULL, extrasId INTEGER, complexion VARCHAR(5) NOT NULL, CONSTRAINT fk_eyes FOREIGN KEY (eyesId) REFERENCES eyes(id), CONSTRAINT fk_mouth FOREIGN KEY (mouthId) REFERENCES mouths(id))";
